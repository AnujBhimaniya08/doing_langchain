...
class Review(BaseModel):
    ...
    name : Optional[str] = Field("write down the name of the reviewer")
...
A review by acnlakchjoaicmn
                                 """)

print(result.pros) # this time result is a pydantic object so cant use dict syntax