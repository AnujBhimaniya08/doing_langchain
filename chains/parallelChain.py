...
parallel_chain = RunnableParallel({'notes' : prompt1 | model1 | parser, 'quiz' : prompt2 | model1 | parser}) # here you can also use model2 (claude ) but tried will same model in both parallel chain operation, will work or not, it worked !
